...
export function CountryCodeSelector({ value, onChange }: CountryCodeSelectorProps) {
  return (
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger className="w-[140px] rounded-xl border-slate-200 dark:border-slate-800 focus:ring-[#5a8c12]">
          ...
          {countryCodes.map((country) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 truncate max-w-[60px]">{country.name}</span>
              </div>
            </SelectItem>
          ))}
        </ScrollArea>
